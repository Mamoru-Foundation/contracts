...
contract BscMamoruRelay is Ownable {
    ...
    function getIncidentsSinceByDaemon(string memory daemonId, uint256 sinceTimestamp, uint limit) public view returns (Incident[] memory, uint256) {
