...
import {BscMamoruRelay} from "../typechain-types";
import IncidentStruct = BscMamoruRelay.IncidentStruct;


describe("BscMamoruRelay", function () {
  const LIMIT = 100;
  ...
  async function deployOneYearLockFixture() {
    ...
    const RelayContract = await ethers.getContractFactory("BscMamoruRelay");
